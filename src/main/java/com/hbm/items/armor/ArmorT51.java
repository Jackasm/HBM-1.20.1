...
import com.hbm.render.item.armor.ArmorT51ItemsRenderer;
...
public class ArmorT51 extends ArmorFSBPowered {
    ...
    @OnlyIn(Dist.CLIENT)
    private ModelArmorT51[] models;

    public ArmorT51(ArmorMaterial material, Type type, Properties properties,
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> defaultModel) {
                if (models == null) {
                    ...
                    for (int i = 0; i < 4; i++) {
                        ...
                        ModelPart root = mc.getEntityModels().bakeLayer(ModelArmorT51.T51_LAYERS[i]);
                        models[i] = new ModelArmorT51(root, i);
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                return new ArmorT51ItemsRenderer();
            }
        });
    }
