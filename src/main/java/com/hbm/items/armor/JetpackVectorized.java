...
public class JetpackVectorized extends JetpackFueledBase {
    ...
    public JetpackVectorized(ArmorMaterial material, Type type, Properties properties, Supplier<FluidTypeHBM> fuel, int maxFuel) {
    ...
    public @NotNull String getArmorTexture(ItemStack stack, net.minecraft.world.entity.Entity entity, EquipmentSlot slot, String type) {
        return "hbm:textures/models/armor/jetpack_green.png";
    }
}