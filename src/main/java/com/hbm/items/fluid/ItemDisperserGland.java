...
public class ItemDisperserGland extends ItemFluidContainer {

    public static final int CAPACITY = 2000;

    public ItemDisperserGland(Properties properties) {
        super(properties, CAPACITY);
    }

    public static ItemStack createEmpty() {
        return createEmpty(ModItems.GLYPHID_GLAND.get());
    }

    public static ItemStack createForFluid(FluidTypeHBM fluid) {
        return createForFluid(ModItems.GLYPHID_GLAND.get(), fluid);
    }
