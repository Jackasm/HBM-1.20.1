...
public class AnvilRecipeCategory implements IRecipeCategory<HBMRecipeWrapper> {
    private final IDrawable background;
    private final IDrawable icon;

    public static final RecipeType<HBMRecipeWrapper> TYPE = HBMJeiRecipeTypes.ANVIL;
