...
public class CrucibleRecipeCategory implements IRecipeCategory<HBMRecipeWrapper> {

    public static final RecipeType<HBMRecipeWrapper> TYPE = HBMJeiRecipeTypes.CRUCIBLE;
    ...
    public CrucibleRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.background = guiHelper.createDrawable(
                ResLocation(MODID, "textures/gui/jei/jei_crucible.png"),
                0, 0, 159, 105
        );
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                new ItemStack(ModBlocks.MACHINE_CRUCIBLE.get()));
    }
