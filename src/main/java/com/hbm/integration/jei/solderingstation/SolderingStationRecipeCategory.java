...
public class SolderingStationRecipeCategory implements IRecipeCategory<HBMRecipeWrapper> {

    public static final RecipeType<HBMRecipeWrapper> TYPE = HBMJeiRecipeTypes.SOLDERING_STATION;
    ...
    public SolderingStationRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(
                ResLocation(MODID, "textures/gui/jei/gui_soldering_station.png"),
                0, 0, 140, 96
        );
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                new ItemStack(ModBlocks.MACHINE_SOLDERING_STATION.get()));
    }
    ...
    public @NotNull Component getTitle() {
        return Component.translatable("block.hbm.machines.machine_soldering_station");
    }
