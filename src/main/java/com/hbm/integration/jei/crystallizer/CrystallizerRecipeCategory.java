...
public class CrystallizerRecipeCategory implements IRecipeCategory<HBMRecipeWrapper> {

    public static final RecipeType<HBMRecipeWrapper> TYPE = HBMJeiRecipeTypes.CRYSTALLIZER;
    ...
    public CrystallizerRecipeCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(
                ResLocation(MODID, "textures/gui/jei/gui_crystallizer.png"),
                0, 0, 140, 96
        );
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                new ItemStack(ModBlocks.MACHINE_CRYSTALLIZER.get()));
    }
    ...
    public @NotNull Component getTitle() {
        return Component.translatable("block.hbm.machines.machine_crystallizer");
    }
