...
public class RTTYSystem {
    ...
    public static HashMap<Pair<Level, String>, RTTYChannel> broadcast = new HashMap<>();

    /** New message queue for writing, gets written into readable Map later on */
    public static HashMap<Pair<Level, String>, Object> newMessages = new HashMap<>();
    ...
    public static void broadcast(Level world, String channelName, Object signal) {
        Pair<Level, String> identifier = new Pair<>(world, channelName);
    ...
    public static void updateBroadcastQueue() {
        ...
        for (Entry<Pair<Level, String>, Object> worldEntry : newMessages.entrySet()) {
            ...
            channel.timeStamp = identifier.key().getGameTime();
