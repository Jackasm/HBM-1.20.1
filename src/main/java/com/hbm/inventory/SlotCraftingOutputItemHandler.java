...
/**
 * Слот для вывода крафта для IItemHandler (пресс и другие механизмы)
 */
public class SlotCraftingOutputItemHandler extends SlotItemHandler {
    private final Player player;

    public SlotCraftingOutputItemHandler(Player player, IItemHandler itemHandler, int index, int x, int y) {
