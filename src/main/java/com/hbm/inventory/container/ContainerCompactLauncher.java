...
public class ContainerCompactLauncher extends AbstractContainerMenu {

    private final TileEntityCompactLauncher launcher;
    private final IItemHandler handler;

    public ContainerCompactLauncher(int windowId, Inventory invPlayer, TileEntityCompactLauncher launcher) {
        super(ModContainers.COMPACT_LAUNCHER.get(), windowId);
        ...
        this.addSlot(new SlotItemHandler(handler, 2, 116, 72)); // топливо в
        this.addSlot(new SlotItemHandler(handler, 3, 134, 72)); // окислитель в
        this.addSlot(new SlotItemHandler(handler, 4, 152, 90)); // твёрдое топливо
        this.addSlot(new SlotItemHandler(handler, 5, 116, 108)); // батарея
        this.addSlot(new SlotItemHandler(handler, 6, 116, 90)); // топливо вых
        this.addSlot(new SlotItemHandler(handler, 7, 134, 90)); // окислитель вых
    ...
    public TileEntityCompactLauncher getLauncher() {
        return launcher;
    }
