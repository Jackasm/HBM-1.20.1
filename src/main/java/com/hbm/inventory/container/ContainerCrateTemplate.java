...
public class ContainerCrateTemplate extends AbstractContainerMenu {

    public final TileEntityCrateTemplate crate;

    public ContainerCrateTemplate(int id, Inventory inv, TileEntityCrateTemplate crate) {
        super(ModContainers.CRATE_TEMPLATE.get(), id);
        this.crate = crate;
