...
public abstract class FluidTrait {
    ...
    static {
        ...
        registerTrait("noid", FluidTraitsSimple.FT_NoID.class);
    ...
    public void onFluidRelease(Level level, BlockPos pos, FluidTank fluid, int amount, FluidReleaseType type) { }
