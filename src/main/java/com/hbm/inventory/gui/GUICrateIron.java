...
public class GUICrateIron extends AbstractContainerScreen<ContainerCrateIron> {
    ...
    private static final ResourceLocation TEXTURE = ResLocation(RefStrings.MODID, "textures/gui/storage/gui_crate_iron.png");
    private final TileEntityCrateIron crate;

    public GUICrateIron(ContainerCrateIron container, Inventory inv, Component title) {
