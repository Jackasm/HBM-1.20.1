...
import com.hbm.items.ISmeltableMaterial;
...
public class Mats {
    ...
    public static final NTMMaterial MAT_GOLD         = makeSmeltable(7900,      GOLD,            0xFFFF8B, 0xC26E00, 0xE8D754).setAutogen(FRAGMENT, WIRE, NUGGET, DUST, DENSEWIRE, CASTPLATE, BLOCK, PLATE, CRYSTAL).m();
    ...
    public static final NTMMaterial MAT_WROUGHTIRON  = makeSmeltable(2602,      df("wrought_iron"), 0xFAAB89).m();
    public static final NTMMaterial MAT_PIGIRON      = makeSmeltable(2603,      df("pig_iron"),   0xFF8B59).m();
    public static final NTMMaterial MAT_METEORICIRON = makeSmeltable(2604,      df("meteoric_iron"), 0x715347).m();
    ...
    public static final NTMMaterial MAT_U238         = makeSmeltable(9238,      U238,            0xC1C7BD, 0x2B3227, 0x9AA196).setAutogen(FRAGMENT, NUGGET, BILLET, DUST, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_PU238        = makeSmeltable(9438,      PU238,           0xFFBC59, 0xFF8E2B, 0x78817E).setAutogen(NUGGET, BILLET, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_TUNGSTEN     = makeSmeltable(7400,      W,               0x868686, 0x000000, 0x977474).setAutogen(FRAGMENT, WIRE, BOLT, DUST, DENSEWIRE, CASTPLATE, WELDEDPLATE, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_LEAD         = makeSmeltable(8200,      PB,              0xA6A6B2, 0x03030F, 0x646470).setAutogen(FRAGMENT, NUGGET, WIRE, BOLT, DUST, DUSTTINY, PLATE, CASTPLATE, PIPE, BLOCK, CRYSTAL).m();
    public static final NTMMaterial MAT_BISMUTH      = makeSmeltable(8300,      BI,              0xB200FF, 0xB200FF, 0xB200FF).setAutogen(FRAGMENT, NUGGET, BILLET, DUST, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_COBALT       = makeSmeltable(2700,      CO,              0xC2D1EE, 0x353554, 0x8F72AE).setAutogen(FRAGMENT, NUGGET, DUSTTINY, BILLET, DUST, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_RED_COPPER     = makeSmeltable(_AS + 1, RED_COPPER,        0xFFBA7D, 0xAF1700, 0xE44C0F).setAutogen(WIRE, DUST, DENSEWIRE, BLOCK, INGOT, DUST, DUSTTINY).m();
    ...
    public static final NTMMaterial MAT_DURA         = makeSmeltable(_AS + 3,   DURA,            0x82A59C, 0x06281E, 0x42665C).setAutogen(BOLT, DUST, PLATE, CASTPLATE, PIPE, BLOCK, INGOT, LIGHTBARREL, HEAVYBARREL, LIGHTRECEIVER, HEAVYRECEIVER, GRIP).m();
    ...
    public static final NTMMaterial MAT_BBRONZE      = makeSmeltable(_AS + 16,  BBRONZE,         0xE19A69, 0x485353, 0x987D65).setAutogen(CASTPLATE, LIGHTBARREL, LIGHTRECEIVER, HEAVYRECEIVER, INGOT).m();
    public static final NTMMaterial MAT_ABRONZE      = makeSmeltable(_AS + 17,  ABRONZE,         0xDB9462, 0x203331, 0x77644D).setAutogen(CASTPLATE, LIGHTBARREL, LIGHTRECEIVER, HEAVYRECEIVER, INGOT).m();
    public static final NTMMaterial MAT_BSCCO        = makeSmeltable(_AS + 18,  BSCCO,           0x767BF1, 0x000000, 0x5E62C0).setAutogen(DENSEWIRE).m();
    public static final NTMMaterial MAT_MAGTUNG      = makeSmeltable(_AS + 8,   MAGTUNG,         0x22A2A2, 0x0F0F0F, 0x22A2A2).setAutogen(WIRE, DUST, DENSEWIRE, BLOCK, INGOT).m();
    ...
    public static final NTMMaterial MAT_GUNMETAL     = makeSmeltable(_AS + 19,  GUNMETAL,        0xFFEF3F, 0xAD3600, 0xF9C62C).setAutogen(LIGHTBARREL, HEAVYBARREL, LIGHTRECEIVER, HEAVYRECEIVER, MECHANISM, STOCK, GRIP, INGOT, PLATE).n();
    ...
    public static final NTMMaterial MAT_POLYCARBONATE = makeNonSmeltable(_ES + 04, PC,           0xEDE7C4, 0x908A67, 0xE1DBB8).setAutogen(STOCK, GRIP).n();
    public static final NTMMaterial MAT_PVC          = makeNonSmeltable(_ES + 05, PVC,          0xFCFCFC, 0x9F9F9F, 0xF0F0F0).setAutogen(STOCK, GRIP).n();

    static {
        // Теперь все MaterialShapes уже созданы, можно безопасно заполнить prefixByName
        MaterialShapes.registerPrefixes();
    }

    public static void registerMaterialEntries() {
        materialEntries.put(new ComparableStack(Items.COAL).makeSingular(),
                List.of(new MaterialStack(MAT_COAL, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.CHARCOAL).makeSingular(),
                List.of(new MaterialStack(MAT_COAL, INGOT.q(1))));

        // Руды
        materialEntries.put(new ComparableStack(Items.IRON_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_IRON, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.DEEPSLATE_IRON_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_IRON, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.COPPER_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_COPPER, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.DEEPSLATE_COPPER_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_COPPER, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.GOLD_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_GOLD, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.DEEPSLATE_GOLD_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_GOLD, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.COAL_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_COAL, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.DEEPSLATE_COAL_ORE).makeSingular(),
                List.of(new MaterialStack(MAT_COAL, INGOT.q(1))));

        // Сырые материалы (1.17+)
        materialEntries.put(new ComparableStack(Items.RAW_IRON).makeSingular(),
                List.of(new MaterialStack(MAT_IRON, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.RAW_COPPER).makeSingular(),
                List.of(new MaterialStack(MAT_COPPER, INGOT.q(1))));
        materialEntries.put(new ComparableStack(Items.RAW_GOLD).makeSingular(),
                List.of(new MaterialStack(MAT_GOLD, INGOT.q(1))));

        materialEntries.put(new ComparableStack(Items.REDSTONE).makeSingular(),
                List.of(new MaterialStack(MAT_REDSTONE, MaterialShapes.DUST.q(1))));

    }

    // Helper methods
    public static NTMMaterial makeSmeltable(int id, DictFrame dict, int color) {
        return makeSmeltable(id, dict, color, color, color);
    }
    ...
    public static NTMMaterial makeSmeltable(int id, DictFrame dict, int solidColorLight, int solidColorDark, int moltenColor) {
        return new NTMMaterial(id, dict).smeltable(SmeltingBehavior.SMELTABLE)
                .setSolidColor(solidColorLight, solidColorDark).setMoltenColor(moltenColor);
    }

    public static NTMMaterial makeAdditive(int id, DictFrame dict, int solidColorLight, int solidColorDark, int moltenColor) {
        return new NTMMaterial(id, dict).smeltable(SmeltingBehavior.ADDITIVE)
                .setSolidColor(solidColorLight, solidColorDark).setMoltenColor(moltenColor);
    }

    public static NTMMaterial makeNonSmeltable(int id, DictFrame dict, int solidColorLight, int solidColorDark, int moltenColor) {
        return new NTMMaterial(id, dict).smeltable(SmeltingBehavior.NOT_SMELTABLE)
                .setSolidColor(solidColorLight, solidColorDark).setMoltenColor(moltenColor);
    }
    ...
    public static String formatAmount(int amount, boolean showInMb) {
        ...
        if (blocks > 0) format.append(blocks).append(" ").append(Component.translatable(blocks == 1 ? "matshape.block" : "matshape.blocks").getString()).append(" ");
        if (ingots > 0) format.append(ingots).append(" ").append(Component.translatable(ingots == 1 ? "matshape.ingot" : "matshape.ingots").getString()).append(" ");
        if (nuggets > 0) format.append(nuggets).append(" ").append(Component.translatable(nuggets == 1 ? "matshape.nugget" : "matshape.nuggets").getString()).append(" ");
        if (quanta > 0) format.append(quanta).append(" ").append(Component.translatable(quanta == 1 ? "matshape.quantum" : "matshape.quanta").getString()).append(" ");
    ...
    public static List<MaterialStack> getSmeltingMaterialsFromItem(ItemStack stack) {
        ...
        // 0. Приоритетная проверка для мультипредметов
        if (checkSmeltableMaterial(stack, result)) return result;

        // 1. Прямые записи (materialEntries)
        if (checkDirectEntries(stack, result)) return result;

        // 2. Поиск по тегам (OreDict)
        if (checkTags(stack, result)) return result;

        // 3. Универсальный поиск по имени предмета (autogen)
        if (checkAutogenName(stack, result)) return result;

        // 4. Запасной вариант: forge-теги
        if (checkForgeTags(stack, result)) return result;

        // 5. Обработка мусора (ItemScraps)
        checkScraps(stack, result);

        return result;
    }

    // Вспомогательная функция: добавляет MaterialStack с учётом конверсии при переплавке
    private static void addWithConversion(List<MaterialStack> list, MaterialStack ms) {
        if (ms.material.smeltsInto != ms.material) {
            int amount = ms.amount * ms.material.convOut / ms.material.convIn;
            list.add(new MaterialStack(ms.material.smeltsInto, amount));
        } else {
            list.add(ms.copy());
        }
    }

    // 0. Проверка мультипредметов через ISmeltableMaterial
    private static boolean checkSmeltableMaterial(ItemStack stack, List<MaterialStack> result) {
        if (stack.getItem() instanceof ISmeltableMaterial smeltable) {
            MaterialStack ms = smeltable.getMaterialStack(stack);
            if (ms != null && ms.amount > 0) {
                addWithConversion(result, ms);
                return true;
            }
        }
        return false;
    ...
    // 1. Проверка прямых записей (materialEntries)
    private static boolean checkDirectEntries(ItemStack stack, List<MaterialStack> result) {
        List<MaterialStack> direct = materialEntries.get(new ComparableStack(stack).makeSingular());
        if (direct != null) {
            for (MaterialStack ms : direct) {
                if (ms != null) addWithConversion(result, ms);
            }
    ...
    // 2. Поиск по тегам (OreDict)
    private static boolean checkTags(ItemStack stack, List<MaterialStack> result) {
        for (var tag : stack.getTags().toList()) {
            String tagName = tag.location().toString();

            // 2a. Записи по тегу (materialOreEntries)
            if (checkOreEntries(tagName, result)) return true;

            // 2b. Разбор префикса из тега (например, forge:ingots/iron)
            if (checkTagPrefix(tag, result)) return true;
        }
        return false;
    }

    // 2a. Записи по тегу (materialOreEntries)
    private static boolean checkOreEntries(String tagName, List<MaterialStack> result) {
        List<MaterialStack> fromOreEntries = materialOreEntries.get(tagName);
        if (fromOreEntries != null) {
            for (MaterialStack ms : fromOreEntries) {
                if (ms != null) addWithConversion(result, ms);
            }
            return !result.isEmpty();
        }
    ...
    // 2b. Разбор префикса из тега
    private static boolean checkTagPrefix(TagKey<?> tag, List<MaterialStack> result) {
        String tagPath = tag.location().getPath();

        for (var prefixEntry : Mats.prefixByName.entrySet()) {
            String prefix = prefixEntry.getKey();
            String materialName = null;

            if (tagPath.startsWith(prefix + "s/")) {
                materialName = tagPath.substring(prefix.length() + 2);
            } else if (tagPath.startsWith(prefix + "/")) {
                materialName = tagPath.substring(prefix.length() + 1);
            }

            if (materialName != null) {
                NTMMaterial material = Mats.matByName.get(materialName);
                if (material != null && material.smeltable != SmeltingBehavior.NOT_SMELTABLE) {
                    int amount = prefixEntry.getValue().q(1);
                    addWithConversion(result, new MaterialStack(material, amount));
                    return true;
                }
            }
        }
    ...
    // 3. Универсальный поиск по имени предмета (autogen)
    private static boolean checkAutogenName(ItemStack stack, List<MaterialStack> result) {
        ResourceLocation itemId = BuiltInRegistries.ITEM.getKey(stack.getItem());
        if (itemId == null) return false;

        String path = itemId.getPath();

        // 3a. Форматы: shape_material или shapes_material
        if (checkShapeName(path, result)) return true;

        // 3b. raw_material или material_ore
        if (checkOreAndRawName(path, result)) return true;

        return false;
    }

    // 3a. Поиск по формату shape_material или shapes_material
    private static boolean checkShapeName(String path, List<MaterialStack> result) {
        for (NTMMaterial material : Mats.orderedList) {
            for (MaterialShapes shape : material.autogen) {
                if (shape == null || shape.noAutogen) continue;
                for (String matName : material.names) {
                    String singular = shape.name() + "_" + matName;
                    String plural = shape.name() + "s_" + matName;
                    if (path.equals(singular) || path.equals(plural)) {
                        addWithConversion(result, new MaterialStack(material, shape.q(1)));
                        return true;
                    }
                }
            }
    ...
    // 3b. Поиск raw_material, ore_material, ore_material_deepslate
    private static boolean checkOreAndRawName(String path, List<MaterialStack> result) {
        for (var entry : Mats.matByName.entrySet()) {
            String matName = entry.getKey();

            if (path.equals("raw_" + matName)) {
                addWithConversion(result, new MaterialStack(entry.getValue(), INGOT.q(1)));
                return true;
            }

            if (path.equals("ore_" + matName)) {
                addWithConversion(result, new MaterialStack(entry.getValue(), INGOT.q(1)));
                return true;
            }

            if (path.equals("ore_" + matName + "_deepslate")) {
                addWithConversion(result, new MaterialStack(entry.getValue(), INGOT.q(1)));
                return true;
            }
        }
    ...
    // 4. Запасной вариант: forge-теги (ingots, plates, dusts, blocks)
    private static boolean checkForgeTags(ItemStack stack, List<MaterialStack> result) {
        for (var entry : Mats.matByName.entrySet()) {
            String matName = entry.getKey();
            NTMMaterial material = entry.getValue();

            // Блоки
            if (stack.is(TagKey.create(Registries.ITEM, ResLocation("forge", "blocks/" + matName))) ||
                    stack.is(TagKey.create(Registries.ITEM, ResLocation("forge", "storage_blocks/" + matName)))) {
                addWithConversion(result, new MaterialStack(material, BLOCK.q(1)));
                return true;
            }

            // Маленькая пыль
            if (stack.is(TagKey.create(Registries.ITEM, ResLocation("forge", "dusts_tiny/" + matName)))) {
                addWithConversion(result, new MaterialStack(material, DUSTTINY.q(1)));
                return true;
            }

            // Пластины
            if (stack.is(TagKey.create(Registries.ITEM, ResLocation("forge", "plates/" + matName)))) {
                addWithConversion(result, new MaterialStack(material, PLATE.q(1)));
                return true;
            }

            // Слитки
            if (stack.is(TagKey.create(Registries.ITEM, ResLocation("forge", "ingots/" + matName)))) {
                addWithConversion(result, new MaterialStack(material, INGOT.q(1)));
                return true;
            }
        }
        return false;
    ...
    // 5. Обработка мусора (ItemScraps)
    private static void checkScraps(ItemStack stack, List<MaterialStack> result) {
        if (stack.getItem() == ModItems.SCRAPS.get()) {
            MaterialStack contents = ItemScraps.getMats(stack);
            if (contents != null) {
                addWithConversion(result, contents);
            }
        }
    }
}