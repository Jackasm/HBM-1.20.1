...
public class ModelArmorDNT extends ModelArmorBase {
    ...
    public static final ModelLayerLocation[] DNT_LAYERS = new ModelLayerLocation[]{
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "dnt_helmet"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "dnt_chest"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "dnt_legs"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "dnt_boots"), "main")
    };

    public ModelArmorDNT(ModelPart root, int type) {
        super(type, root);
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer,
        ...
        if (this.type == 3) {
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/dnt_helmet.png")));
            this.head.render(poseStack, consumer, packedLight, packedOverlay, scale);
        } else if (this.type == 2) {
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/dnt_chest.png")));
            ...
            consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/dnt_arm.png")));
            ...
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/dnt_leg.png")));
