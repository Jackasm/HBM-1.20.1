...
public class ModelArmorHEV extends ModelArmorBase {
    ...
    public static final ModelLayerLocation[] HEV_LAYERS = new ModelLayerLocation[]{
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "hev_helmet"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "hev_chest"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "hev_legs"), "main"),
            new ModelLayerLocation(ResLocation(RefStrings.MODID, "hev_boots"), "main")
    };

    public ModelArmorHEV(ModelPart root, int type) {
        super(type, root);
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer,
        ...
        if (this.type == 3) {
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/hev_helmet.png")));
            this.head.render(poseStack, consumer, packedLight, packedOverlay, scale);
        }
        if (this.type == 2) {
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/hev_chest.png")));
            ...
            consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/hev_arm.png")));
        ...
        if (this.type == 1) {
            VertexConsumer consumer = Minecraft.getInstance().renderBuffers().bufferSource()
                    .getBuffer(RenderType.entityCutoutNoCull(ResLocation(RefStrings.MODID, "textures/models/armor/hev_leg.png")));
