...
@OnlyIn(Dist.CLIENT)
public class ArmorAJRItemsRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext context, PoseStack poseStack,
        ...
        if (item == ModArmorItems.AJR_HELMET.get()) {
            ...
            VertexConsumer consumerArm = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/ajr_arm.png")));
        ...
        } else if (item == ModArmorItems.AJR_LEGGINGS.get()) {
            poseStack.translate(-0.5D, -0.45D, 0.0D);
            VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/ajr_leg.png")));
        ...
        } else if (item == ModArmorItems.AJR_BOOTS.get()) {
