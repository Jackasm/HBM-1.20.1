...
@OnlyIn(Dist.CLIENT)
public class ArmorT51ItemsRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext context, PoseStack poseStack,
        ...
        if (item == ModArmorItems.T51_HELMET.get()) {
            ...
            VertexConsumer consumerArm = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/t51_arm.png")));
        ...
        } else if (item == ModArmorItems.T51_LEGGINGS.get()) {
            poseStack.translate(-0.5D, -0.45D, 0.0D);
            VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/t51_leg.png")));
        ...
        } else if (item == ModArmorItems.T51_BOOTS.get()) {
