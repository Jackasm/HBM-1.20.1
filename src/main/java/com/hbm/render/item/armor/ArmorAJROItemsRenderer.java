...
@OnlyIn(Dist.CLIENT)
public class ArmorAJROItemsRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext context, PoseStack poseStack,
        ...
        if (item == ModArmorItems.AJRO_HELMET.get()) {
            ...
            VertexConsumer consumerArm = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/ajro_arm.png")));
        ...
        } else if (item == ModArmorItems.AJRO_LEGGINGS.get()) {
            poseStack.translate(-0.5D, -0.45D, 0.0D);
            VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/ajro_leg.png")));
        ...
        } else if (item == ModArmorItems.AJRO_BOOTS.get()) {
