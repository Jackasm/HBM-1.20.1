...
@OnlyIn(Dist.CLIENT)
public class ArmorDeshItemsRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext context, PoseStack poseStack,
        ...
        if (item == ModArmorItems.STEAMSUIT_HELMET.get()) {
            ...
            VertexConsumer consumerArm = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/steamsuit_arm.png")));
        ...
        } else if (item == ModArmorItems.STEAMSUIT_LEGGINGS.get()) {
            poseStack.translate(-0.5D, -0.45D, 0.0D);
            VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutoutNoCull(
                    ResLocation(RefStrings.MODID, "textures/models/armor/steamsuit_leg.png")));
        ...
        } else if (item == ModArmorItems.STEAMSUIT_BOOTS.get()) {
