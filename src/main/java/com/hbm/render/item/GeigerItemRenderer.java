...
public class GeigerItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private static final ResourceLocation TEXTURE = ResLocation(RefStrings.MODID, "textures/block/geiger.png");
    private final ModelGeiger model;

    public GeigerItemRenderer() {
        super(Minecraft.getInstance().getBlockEntityRenderDispatcher(),
                Minecraft.getInstance().getEntityModels());
        this.model = new ModelGeiger();
    }
