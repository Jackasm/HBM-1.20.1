...
public class BlastFurnaceItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        ResourceLocation texture = HBMResourceManager.machine_blast_furnace_lit_tex;
        VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(texture));

        HBMResourceManager.blast_furnace.renderAll(poseStack, consumer, light, packedOverlay);
