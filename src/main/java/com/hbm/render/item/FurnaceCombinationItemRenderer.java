...
public class FurnaceCombinationItemRenderer extends BlockEntityWithoutLevelRenderer {

    public FurnaceCombinationItemRenderer() {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        // Рендерим модель
        HBMResourceManager.furnace_combination.renderAll(poseStack, vertexConsumer, light, packedOverlay);
