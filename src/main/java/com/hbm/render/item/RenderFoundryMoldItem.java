...
public class RenderFoundryMoldItem extends BlockEntityWithoutLevelRenderer {

    private static final ResourceLocation TEXTURE = ResLocation("hbm", "textures/block/network/foundry_mold.png");

    public RenderFoundryMoldItem() {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        HBMResourceManager.foundry_mold.renderAll(poseStack, buffer, TEXTURE, packedLight, packedOverlay);
