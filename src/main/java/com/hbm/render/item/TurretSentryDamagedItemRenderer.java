...
public class TurretSentryDamagedItemRenderer extends BlockEntityWithoutLevelRenderer {

    public TurretSentryDamagedItemRenderer() {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutoutNoCull(HBMResourceManager.turret_sentry_damaged_tex));
