...
public class OilburnerItemRenderer extends BlockEntityWithoutLevelRenderer {

    public OilburnerItemRenderer() {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        HBMResourceManager.heater_oilburner.renderAll(poseStack, vertexConsumer, light, packedOverlay);
