...
public class BoilerItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        if (stack.getDamageValue() == 1) {
            HBMResourceManager.heat_boiler_burst.renderAll(poseStack, vertexConsumer, light, packedOverlay);
        } else {
            HBMResourceManager.heat_boiler.renderAll(poseStack, vertexConsumer, light, packedOverlay);
        }
