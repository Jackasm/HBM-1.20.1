...
public class RenderFoundryBasinItem extends BlockEntityWithoutLevelRenderer {

    private static final ResourceLocation TEXTURE = ResLocation("hbm", "textures/block/network/foundry_basin.png");

    public RenderFoundryBasinItem() {
    ...
    public void renderByItem(@NotNull ItemStack stack, @NotNull ItemDisplayContext context,
        ...
        HBMResourceManager.foundry_basin.renderAll(poseStack, buffer, TEXTURE, packedLight, packedOverlay);
