...
public class RadiorecItemRenderer extends BlockEntityWithoutLevelRenderer {

    private static final ResourceLocation TEXTURE = ResLocation(RefStrings.MODID, "textures/block/model_radio_receiver.png");
    private final ModelBroadcaster model;

    public RadiorecItemRenderer() {
