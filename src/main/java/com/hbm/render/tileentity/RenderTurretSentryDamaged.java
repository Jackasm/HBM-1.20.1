...
public class RenderTurretSentryDamaged implements BlockEntityRenderer<TileEntityTurretSentryDamaged> {

    public RenderTurretSentryDamaged(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(@NotNull TileEntityTurretSentryDamaged turret, float partialTick, @NotNull PoseStack poseStack,
    ...
    @Override
    public boolean shouldRenderOffScreen(@NotNull TileEntityTurretSentryDamaged tile) {
        return true;
    }
