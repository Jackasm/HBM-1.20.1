...
@OnlyIn(Dist.CLIENT)
public class HeaterOvenRenderer implements BlockEntityRenderer<TileEntityHeaterOven> {

    public HeaterOvenRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(TileEntityHeaterOven tile, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        poseStack.pushPose();
        ...
        ResourceLocation texture = HBMResourceManager.heater_oven_tex;
