...
public class BlastFurnaceTrigger extends SimpleCriterionTrigger<BlastFurnaceTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "blast_furnace");
