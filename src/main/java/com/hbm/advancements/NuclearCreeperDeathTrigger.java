...
public class NuclearCreeperDeathTrigger extends SimpleCriterionTrigger<NuclearCreeperDeathTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "nuclear_creeper_death");
