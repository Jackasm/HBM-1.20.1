...
public class ChemplantTrigger extends SimpleCriterionTrigger<ChemplantTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "chemplant");
