...
public class RadPoisonTrigger extends SimpleCriterionTrigger<RadPoisonTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "rad_poison");
