...
public class HorizonsStartTrigger extends SimpleCriterionTrigger<HorizonsStartTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "horizons_start");
