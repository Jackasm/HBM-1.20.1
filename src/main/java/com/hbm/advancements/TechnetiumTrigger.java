...
public class TechnetiumTrigger extends SimpleCriterionTrigger<TechnetiumTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "technetium");
