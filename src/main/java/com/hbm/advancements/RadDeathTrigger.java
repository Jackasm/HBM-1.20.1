...
public class RadDeathTrigger extends SimpleCriterionTrigger<RadDeathTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "rad_death");
