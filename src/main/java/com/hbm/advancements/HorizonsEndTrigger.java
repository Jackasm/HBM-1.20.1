...
public class HorizonsEndTrigger extends SimpleCriterionTrigger<HorizonsEndTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "horizons_end");
