...
public class SomeWoundsTrigger extends SimpleCriterionTrigger<SomeWoundsTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "some_wounds");
