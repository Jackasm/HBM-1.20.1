...
public class AssemblyTrigger extends SimpleCriterionTrigger<AssemblyTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "assembly");
