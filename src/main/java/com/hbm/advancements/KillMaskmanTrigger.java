...
public class KillMaskmanTrigger extends SimpleCriterionTrigger<KillMaskmanTrigger.Instance> {

    private static final ResourceLocation ID = ResLocation(MODID, "kill_maskman");
