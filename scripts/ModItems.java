...
public class ModItems {
	...
	public static void initializeItem() {
		...
		mp_stability_15_soyuz = new ItemCustomMissilePart().makeStability(0.25F, PartSize.SIZE_15).setHealth(15F).setRarity(Rarity.COMMON).setWittyText("Ñîþç!").setUnlocalizedName("mp_stability_15_soyuz");
