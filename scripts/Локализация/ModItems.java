...
public class ModItems {
    ...
    public static final RegistryObject<Item> MACHINE_BLAST_FURNACE = register(MACHINE_TAB, "machines/machine_blast_furnace",
            () -> new BlockItem(ModBlocks.MACHINE_BLAST_FURNACE.get(), new Item.Properties()));

    public static final RegistryObject<Item> BLAST_FURNACE_EXTENSION = register(MACHINE_TAB, "machines/blast_furnace_extension",
            () -> new BlockItem(ModBlocks.BLAST_FURNACE_EXTENSION.get(), new Item.Properties()));

    public static final RegistryObject<Item> MACHINE_DI_FURNACE_EXTENSION =
            register(MACHINE_TAB, "machines/machine_difurnace_extension",
            () -> new BlockItem(ModBlocks.MACHINE_DI_FURNACE_EXTENSION.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> FLUID_TANK_LEAD = register("fluid_tank_lead",
            () -> new ItemFluidTank(new Item.Properties()), ItemModelType.GENERATED_LAYERED,
    ...
    public static final RegistryObject<Item> PELLET_RTG_DEPLETED = register(PARTS_TAB, "pellet_rtg_depleted",
    ...
    public static final RegistryObject<Item> PART_GENERIC = register(PARTS_TAB, "part_generic",
